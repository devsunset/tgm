...
func init() {
	...
	rootCmd.SetVersionTemplate("tgm version {{printf \"%s\" .Version}}\n")

	flags := rootCmd.Flags()
	persistent := rootCmd.PersistentFlags()

	persistent.StringVarP(&cfgFile, "config", "c", "", "config file path")
	persistent.StringP("database", "d", "./tgm.db", "database path")
...
var rootCmd = &cobra.Command{
	Use:   "tgm",
	Short: "A stylish web-based tgm",
	Long: `tgm CLI lets you create the database to use with tgm,
manage your users and all the configurations without acessing the
web interface.

If you've never run tgm, you'll need to have a database for
...
.tgm.{json, toml, yaml, yml} in the following directories:
...
Also, if the database path doesn't exist, tgm will enter into
