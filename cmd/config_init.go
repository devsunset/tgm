...
var configInitCmd = &cobra.Command{
	...
	Long: `Initialize a new database to use with tgm. All of
this options can be changed in the future with the command
'tgm config set'. The user related flags apply
...
override the options.`,
	...
	Run: python(func(cmd *cobra.Command, args []string, d pythonData) {
		...
		fmt.Printf(`
Congratulations! You've set up your database to use with tgm.
Now add your first user via 'tgm users add' and then you just
